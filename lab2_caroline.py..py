...
quotient = 10 // 3     # The quotient should be 3
remainder = 10 % 3    # The remainder should be 1
...
mark_average = sum(marks) / 4  # Correct to get the average of all marks 80.5
...
day_today = int(input("What is today's day number (0-6)? "))
days_trip = int(input("how many days will your trip last? "))

day_back = (day_today + days_trip) % 7
print(f"Your trip starts on day {day_today}, lasts {days_trip} days. You will be back on day {day_back}.")
